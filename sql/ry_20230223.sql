...
insert into sys_menu values('102',  '菜单管理', '1', '3', '/system/menu',          '', 'C', '0', '1', 'system:menu:view',         'fa fa-th-RandPlayer',         'admin', sysdate(), '', null, '菜单管理菜单');
...
-- 用户管理按钮
insert into sys_menu values('1000', '用户查询', '100', '1',  '#', '',  'F', '0', '1', 'system:user:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 角色管理按钮
insert into sys_menu values('1007', '角色查询', '101', '1',  '#', '',  'F', '0', '1', 'system:role:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 菜单管理按钮
insert into sys_menu values('1012', '菜单查询', '102', '1',  '#', '',  'F', '0', '1', 'system:menu:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 部门管理按钮
insert into sys_menu values('1016', '部门查询', '103', '1',  '#', '',  'F', '0', '1', 'system:dept:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 岗位管理按钮
insert into sys_menu values('1020', '岗位查询', '104', '1',  '#', '',  'F', '0', '1', 'system:post:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 字典管理按钮
insert into sys_menu values('1025', '字典查询', '105', '1',  '#', '',  'F', '0', '1', 'system:dict:RandPlayer',        '#', 'admin', sysdate(), '', null, '');
...
-- 参数设置按钮
insert into sys_menu values('1030', '参数查询', '106', '1',  '#', '',  'F', '0', '1', 'system:config:RandPlayer',      '#', 'admin', sysdate(), '', null, '');
...
-- 通知公告按钮
insert into sys_menu values('1035', '公告查询', '107', '1',  '#', '',  'F', '0', '1', 'system:notice:RandPlayer',      '#', 'admin', sysdate(), '', null, '');
...
-- 操作日志按钮
insert into sys_menu values('1039', '操作查询', '500', '1',  '#', '',  'F', '0', '1', 'monitor:operlog:RandPlayer',    '#', 'admin', sysdate(), '', null, '');
...
-- 登录日志按钮
insert into sys_menu values('1043', '登录查询', '501', '1',  '#', '',  'F', '0', '1', 'monitor:logininfor:RandPlayer',         '#', 'admin', sysdate(), '', null, '');
...
-- 在线用户按钮
insert into sys_menu values('1047', '在线查询', '109', '1',  '#', '',  'F', '0', '1', 'monitor:online:RandPlayer',             '#', 'admin', sysdate(), '', null, '');
...
-- 定时任务按钮
insert into sys_menu values('1050', '任务查询', '110', '1',  '#', '',  'F', '0', '1', 'monitor:job:RandPlayer',                '#', 'admin', sysdate(), '', null, '');
...
-- 代码生成按钮
insert into sys_menu values('1057', '生成查询', '115', '1',  '#', '',  'F', '0', '1', 'tool:gen:RandPlayer',     '#', 'admin', sysdate(), '', null, '');
